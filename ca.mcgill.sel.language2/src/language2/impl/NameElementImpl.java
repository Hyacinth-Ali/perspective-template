 ...
 * </p>
 * <ul>
 *   <li>{@link language2.impl.NameElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NameElementImpl extends MinimalEObjectImpl.Container implements NameElement {
	...
	protected EClass eStaticClass() {
		return Language2Package.Literals.NAME_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Language2Package.NAME_ELEMENT__NAME, oldName, name));
	}
