...
public class RedefinedCModelAction {
	...
	private static void canCreateOrUseElementForC1(COREPerspective perspective, CORELanguageElementMapping mappingType, COREScene scene,
		...
		if (isCreateMapping) {
			...
			if(!otherExist) {
				...
				createOtherElementsForC1(perspective, scene, otherRoleName, otherElement, owner, name);	
			}
		}
	}
	...
	private static void canCreateOrUseElementForC2(COREPerspective perspective, CORELanguageElementMapping mappingType, COREScene scene,
		...
		if (isCreateMapping) {
			...
			if(!otherExist) {
				owner = otherElement.eContainer();
				createOtherElementsForC2(perspective, scene, otherRoleName, otherElement, owner, name);	
			}
		}
	}
	...
	public static EObject createNewC3(COREPerspective perspective, COREScene scene, String currentRole, 
		boolean isFacadeCall, EObject owner, String name) {
	...
	private static void canCreateOrUseElementForC3(COREPerspective perspective, CORELanguageElementMapping mappingType, COREScene scene,
		...
		if (isCreateMapping) {
			...
			if(!otherExist) {
				owner = otherElement.eContainer();
				createOtherElementsForC3(perspective, scene, otherRoleName, otherElement, owner, name);	
			}
		}
	}
	...
	public static EObject createNewC4(COREPerspective perspective, COREScene scene, String currentRole, 
		boolean isFacadeCall, EObject owner, String name) {
	...
	private static void canCreateOrUseElementForC4(COREPerspective perspective, CORELanguageElementMapping mappingType, COREScene scene,
		...
		if (isCreateMapping) {
			...
			if(!otherExist) {
				owner = otherElement.eContainer();
				createOtherElementsForC4(perspective, scene, otherRoleName, otherElement, owner, name);	
			}
		}
	}
