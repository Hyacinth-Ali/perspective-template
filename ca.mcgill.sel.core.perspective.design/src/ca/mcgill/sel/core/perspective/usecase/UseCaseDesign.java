...
public class UseCaseDesign {
 ...
 public static void main(String[] args) {
        ...
        COREConcern perspectiveConcern = COREModelUtil.createConcern("Use_Cases");
        
        COREPerspective perspective = CoreFactory.eINSTANCE.createCOREPerspective();
        perspective.setName("Use Case Modelling");
            ...
            for (String l : languages) {
                ...
                for (COREArtefact a : languageConcern.getArtefacts()) {
                    if (a instanceof COREExternalLanguage) {
                        ...
                        if (existingLanguage.getName().equals("Use Cases")) {
        ...
        UseCasePerspective.initializePerspective(perspective);
