 ...
 * @generated
 */
public class CmodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CmodelPackage.CMODEL: {
				CModel cModel = (CModel)theEObject;
				T result = caseCModel(cModel);
				if (result == null) result = caseNamedElement(cModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CmodelPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CmodelPackage.C1: {
				C1 c1 = (C1)theEObject;
				T result = caseC1(c1);
				if (result == null) result = caseNamedElement(c1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CmodelPackage.C2: {
				C2 c2 = (C2)theEObject;
				T result = caseC2(c2);
				if (result == null) result = caseNamedElement(c2);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CmodelPackage.C3: {
				C3 c3 = (C3)theEObject;
				T result = caseC3(c3);
				if (result == null) result = caseNamedElement(c3);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CmodelPackage.C4: {
				C4 c4 = (C4)theEObject;
				T result = caseC4(c4);
				if (result == null) result = caseNamedElement(c4);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>CModel</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>CModel</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCModel(CModel object) {
		return null;
	}
