...
//    COREConcern langConcern = COREModelUtil.createConcern("BModel");

    COREExternalLanguage language = CoreFactory.eINSTANCE.createCOREExternalLanguage();
    language.setName("BModel");
    language.setNsURI("http://cs.mcgill.ca/sel/bmodel/1.0");
    language.setResourceFactory("ca.mcgill.sel.bmodel.util.BmodelResourceFactoryImpl");
    language.setAdapterFactory("ca.mcgill.sel.bmodel.provider.BModelItemProviderAdapterFactory");
    language.setWeaverClassName("");
    language.setFileExtension("bmodel");
    language.setModelUtilClassName("ca.mcgill.sel.bmodel.util.Language2ModelUtil");
