...
public class DomainModelDesign {
 ...
 public static void main(String[] args) {
        ...
        COREConcern perspectiveConcern = COREModelUtil.createConcern("Domain_Model");
        
        COREPerspective perspective = CoreFactory.eINSTANCE.createCOREPerspective();
        perspective.setName("Domain Modelling");
        ...
        DomainModelPerspective.initializePerspective(perspective);
