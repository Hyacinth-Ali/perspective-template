...
import ca.mcgill.sel.language1.NamedElement;
...
public class Language1PackageImpl extends EPackageImpl implements Language1Package {
	 ...
	 * @see ca.mcgill.sel.language1.Language1Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		language1EClass.getESuperTypes().add(this.getNamedElement());
		lema1EClass.getESuperTypes().add(this.getNamedElement());
		lemb1EClass.getESuperTypes().add(this.getNamedElement());
		lemc1EClass.getESuperTypes().add(this.getNamedElement());
		lemd1EClass.getESuperTypes().add(this.getNamedElement());
		leme1EClass.getESuperTypes().add(this.getNamedElement());
		lemf1EClass.getESuperTypes().add(this.getNamedElement());
		lemg1EClass.getESuperTypes().add(this.getNamedElement());
		lemh1EClass.getESuperTypes().add(this.getNamedElement());
		lemi1EClass.getESuperTypes().add(this.getNamedElement());
		lemj1EClass.getESuperTypes().add(this.getNamedElement());
		lemk1EClass.getESuperTypes().add(this.getNamedElement());
		leml1EClass.getESuperTypes().add(this.getNamedElement());
		...
		initEClass(lema1EClass, ca.mcgill.sel.language1.LEMA1.class, "LEMA1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemb1EClass, ca.mcgill.sel.language1.LEMB1.class, "LEMB1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemc1EClass, ca.mcgill.sel.language1.LEMC1.class, "LEMC1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemd1EClass, ca.mcgill.sel.language1.LEMD1.class, "LEMD1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(leme1EClass, ca.mcgill.sel.language1.LEME1.class, "LEME1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemf1EClass, ca.mcgill.sel.language1.LEMF1.class, "LEMF1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemg1EClass, ca.mcgill.sel.language1.LEMG1.class, "LEMG1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemh1EClass, ca.mcgill.sel.language1.LEMH1.class, "LEMH1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemi1EClass, ca.mcgill.sel.language1.LEMI1.class, "LEMI1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemj1EClass, ca.mcgill.sel.language1.LEMJ1.class, "LEMJ1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemk1EClass, ca.mcgill.sel.language1.LEMK1.class, "LEMK1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(leml1EClass, ca.mcgill.sel.language1.LEML1.class, "LEML1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
