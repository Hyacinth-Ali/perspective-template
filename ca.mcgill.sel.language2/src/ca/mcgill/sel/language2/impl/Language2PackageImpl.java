...
import ca.mcgill.sel.language2.NamedElement;
...
public class Language2PackageImpl extends EPackageImpl implements Language2Package {
	 ...
	 * @see ca.mcgill.sel.language2.Language2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		language2EClass.getESuperTypes().add(this.getNamedElement());
		lema2EClass.getESuperTypes().add(this.getNamedElement());
		lemb2EClass.getESuperTypes().add(this.getNamedElement());
		lemc2EClass.getESuperTypes().add(this.getNamedElement());
		lemd2EClass.getESuperTypes().add(this.getNamedElement());
		leme2EClass.getESuperTypes().add(this.getNamedElement());
		lemf2EClass.getESuperTypes().add(this.getNamedElement());
		lemg2EClass.getESuperTypes().add(this.getNamedElement());
		lemh2EClass.getESuperTypes().add(this.getNamedElement());
		lemi2EClass.getESuperTypes().add(this.getNamedElement());
		lemj2EClass.getESuperTypes().add(this.getNamedElement());
		lemk2EClass.getESuperTypes().add(this.getNamedElement());
		leml2EClass.getESuperTypes().add(this.getNamedElement());
		...
		initEClass(lema2EClass, ca.mcgill.sel.language2.LEMA2.class, "LEMA2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemb2EClass, ca.mcgill.sel.language2.LEMB2.class, "LEMB2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemc2EClass, ca.mcgill.sel.language2.LEMC2.class, "LEMC2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemd2EClass, ca.mcgill.sel.language2.LEMD2.class, "LEMD2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(leme2EClass, ca.mcgill.sel.language2.LEME2.class, "LEME2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemf2EClass, ca.mcgill.sel.language2.LEMF2.class, "LEMF2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemg2EClass, ca.mcgill.sel.language2.LEMG2.class, "LEMG2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemh2EClass, ca.mcgill.sel.language2.LEMH2.class, "LEMH2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemi2EClass, ca.mcgill.sel.language2.LEMI2.class, "LEMI2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemj2EClass, ca.mcgill.sel.language2.LEMJ2.class, "LEMJ2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(lemk2EClass, ca.mcgill.sel.language2.LEMK2.class, "LEMK2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(leml2EClass, ca.mcgill.sel.language2.LEML2.class, "LEML2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
